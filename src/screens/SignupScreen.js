...
export default function SignupScreen() {
  ...
  const handleSignup = async () => {
    ...
    if (!username.trim() || !email.trim() || !password.trim() || !confirmPassword.trim()) {
      showAlert('warning', 'Incomplete Fields', 'Please fill in all fields.');
      return;
    }

    if (password !== confirmPassword) {
      showAlert('error', 'Password Mismatch', 'Both passwords must match.');
      return;
    }
    ...
    if (result.success) {
      ...
      showAlert('error', 'Sign Up Failed', result.message);
    }
  };
  ...
  const handleGoogleAuth = async () => {
    ...
    if (result?.success) {
      ...
      showAlert('error', 'Google Sign-Up Failed', result?.message || 'An error occurred');
    }
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Sign up to generate AI Magic</Text>
        </View>
